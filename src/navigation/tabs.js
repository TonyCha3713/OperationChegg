        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <View style={{ alignItems: "center", justifyContent: "center", top: 3 }}>
              <Icon name="ios-search" size={26} color={focused ? COLORS.blue : COLORS.white} />
              <Text style={{ color: focused ? COLORS.blue : COLORS.white, fontSize: 10, fontWeight: "bold" }}>Search</Text>
            </View>
          ),
        }}
      />
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <View style={{ alignItems: "center", justifyContent: "center", top: 3, width: 80, height: 80 }}>
              <Icon name="cloud-upload" size={26} color={focused ? COLORS.blue : COLORS.white} />
